...
import com.fuxia.w.view4.model.Comment;
import com.fuxia.w.view4.model.Moment;
import com.fuxia.w.view4.model.User;
...
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    public void inputComment(final View v, User receiver) {
        CommentFun.inputComment(LunActivity.this, mListView, v, receiver, new CommentFun.InputCommentListener() {
            @Override

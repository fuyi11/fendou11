...
public class TanTanActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_tantan);
        initView();
        initData();
    }
    ...
    private void initView() {
        ...
        cardCallback.setOnSwipedListener(new OnSwipeListener<Integer>() {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, Integer o, int direction) {
                ...
                myHolder.dislikeImageView.setAlpha(0f);
                myHolder.likeImageView.setAlpha(0f);
                Toast.makeText(TanTanActivity.this, direction == CardConfig.SWIPED_LEFT ? "刷左" : "刷右", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onSwipedClear() {
                Toast.makeText(TanTanActivity.this, "data clear", Toast.LENGTH_SHORT).show();

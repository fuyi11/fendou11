...
import com.fuxia.w.view17.DisplayUtil;
...
public class RollHeaderView extends FrameLayout implements OnPageChangeListener {
    ...
    private void initView() {
        View.inflate(mContext, R.layout.view_header1, this);
    ...
    public void setImgUrlData(List<String> urlList) {
        ...
        if (mUrlList != null && !mUrlList.isEmpty()) {
            ...
            for (int i = 0; i < mUrlList.size(); i++) {
                ...
                if (i == 0) {
                    dotIv.setBackgroundResource(R.mipmap.dot_focus);
                } else {
                    dotIv.setBackgroundResource(R.mipmap.dot_normal);
                }
                //设置点的间距
    ...
    public void onPageSelected(int position) {
        dotList.get(prePosition).setBackgroundResource(R.mipmap.dot_normal);
        dotList.get(position % dotList.size()).setBackgroundResource(R.mipmap.dot_focus);

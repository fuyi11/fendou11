...
public class RoundImageView extends ImageView {
	...
	private void setCustomAttributes(AttributeSet attrs) {
		TypedArray a = mContext.obtainStyledAttributes(attrs,
				R.styleable.rounded_imageview);
		mBorderThickness = a.getDimensionPixelSize(
				R.styleable.rounded_imageview_border_thickness, 0);
		mBorderOutsideColor = a.getColor(
				R.styleable.rounded_imageview_border_outside_color,
				defaultColor);
		mBorderInsideColor = a
				.getColor(R.styleable.rounded_imageview_border_inside_color,
						defaultColor);
		a.recycle();
	}

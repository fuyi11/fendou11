...
/**
 * Created by fuyi on 2017/3/9.
 */
public class LianDongActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_liangdong);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button5:
                ...
                break;
            case R.id.button6:
                startActivity(new Intent(LianDongActivity.this, ActivityTimePicker.class));
                break;
            case R.id.button7:
                showNPVDialog();
                break;
